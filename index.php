        ...
        <div id="wrapper">
            <aside>
                <nav>
                    ...
                    <a href="http://design.jonathangrover.com" target="_blank">Design</a>
                    <div id="list2">
                        <h3>Code</h3>
                        <div>
                    ...
                    <div id="list3">
                        <h3>About Me</h3>
                        <div>
                            <a href="index.php?p=info">Info</a></li>
                            <a href="index.php?p=bio">Biography</a></li>
                            <a href="index.php?p=cv">Résumé/CV</a></li>
                        </div data-collapse="persist"><!-- end about me -->
                    </div><!-- end list3 -->
                    <a href="index.php?p=contact">Contact</a>
                    <a href="index.php?p=links">Links</a>
                    <a href="index.php?p=follow">Follow Me</a>
                    <a href="http://edu.jonathangrover.com" target="_blank">Teaching</a>
                </nav>
            </aside>
            <section>
                <?php 
